  ...
  observeEvent(modal_trigger(), {
    ...
    showModal(
      modalDialog(
        ...
        radioButtons(
          ns("PM_adm"), # Previous MI
          label = "Previous MI ( > 7Days)",
          choices = c("Yes" = 0, "No" = 1),
          inline = TRUE
        ),
        ...
        radioButtons(
          ...
          label = "Previous CHF at Admission",
          choices = c("Yes" = 0, "No" = 1),
          inline = TRUE
        ),
        ...
        radioButtons(
          ns("PNTB_adm"), # Previous Non-Traumatic Bleeding
          label = "Previous Non-Traumatic Bleeding",
          choices = c("Yes" = 0, "No" = 1),
          inline = TRUE
        ),
