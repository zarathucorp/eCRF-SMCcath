...
m1_edit_module <- function(input, output, session, modal_title, car_to_edit, modal_trigger, tbl = "rct", data, sessionid) {
  ...
  observeEvent(input$CYfA, {
    updateRadioButtons(session, "Aspirin_M1", selected = 0)
    updateRadioButtons(session, "Trimetazidine_M1", selected = 0)
    updateRadioButtons(session, "Clopidogrel_M1", selected = 0)
    updateRadioButtons(session, "Nitrate_M1", selected = 0)
    updateRadioButtons(session, "Prasugrel_M1", selected = 0)
    updateRadioButtons(session, "Statin_M1", selected = 0)
    updateRadioButtons(session, "Ticagrelor_M1", selected = 0)
    updateRadioButtons(session, "BB_M1", selected = 0)
    updateRadioButtons(session, "ACE_M1", selected = 0)
    updateRadioButtons(session, "DPP4_M1", selected = 0)
    updateRadioButtons(session, "Wafarin_M1", selected = 0)
    updateRadioButtons(session, "NOAC_M1", selected = 0)
    updateRadioButtons(session, "Nicorandil_M1", selected = 0)
    updateRadioButtons(session, "Calcium_M1", selected = 0)
    updateRadioButtons(session, "Metformin_M1", selected = 0)
    updateRadioButtons(session, "Sulf_M1", selected = 0)
    updateRadioButtons(session, "Thia_M1", selected = 0)
    updateRadioButtons(session, "GLP_M1", selected = 0)
    updateRadioButtons(session, "Alpha_M1", selected = 0)
    updateRadioButtons(session, "Insulin_M1", selected = 0)
  })
